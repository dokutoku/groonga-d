...
/+
#define GRN_PAT_EACH(ctx, pat, id, key, key_size, value, block) grn_pat_cursor *_sc = grn_pat_cursor_open(ctx, pat, null, 0, null, 0, 0, -1, 0); if (_sc) { uint id; while ((id = grn_pat_cursor_next(ctx, _sc))) { grn_pat_cursor_get_key_value(ctx, _sc, (void **)(key), (key_size), (void **)(value)); block } grn_pat_cursor_close(ctx, _sc); }
+/
